import { GuitarShopUserMongoDbEntity, GuitarShopUserMongoDbModel } from "@guitar-shop/core";
...
export default class GenerateCommandCli implements CliCommandInterface {
  ...
  private readonly userModel: ModelType<GuitarShopUserMongoDbEntity> = GuitarShopUserMongoDbModel;
